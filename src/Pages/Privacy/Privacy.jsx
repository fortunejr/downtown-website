    ...
    <div className="bg-[#ffffff] text-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-6 py-2 mb-12 leading-relaxed">
        ...
        <p className="text-base md:text-lg text-gray-700 mb-10">
          You're using Downtown to get food delivered on campus. We need some of
          your info to make that happen. Here's exactly what we do with it, in
          plain English (no legal mumbo jumbo).
        </p>
        ...
        <p className="text-base md:text-lg text-gray-700 mb-10">
          ...
          WhatsApp has their own privacy rules too, so check those out. But real
          quick: we only see messages you send to our bot. Your group chats and
          personal DMs? None of our business.
        </p>
        ...
        <div className="text-base md:text-lg text-gray-700 mb-1">
          <p className="mb-2 font-medium">
            We're not out here sharing your business with random people. Here's
            who gets what:
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
        ...
        <p className="text-base md:text-lg text-gray-700 mb-10">
          Gotta be 13+ to use Downtown. Under 13? Get your parent or guardian to
          order for you. We don't make the rules... wait, we do, but for good
          reasons.
        </p>
