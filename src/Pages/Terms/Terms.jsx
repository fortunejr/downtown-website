...
const Terms = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service - Downtown</title>
        <meta
          name="description"
          content="Terms and conditions for ordering food from Downtown food court Ota."
        />
        <link rel="canonical" href="https://downtown.ng/terms-of-use" />
      </Helmet>
      <div className="bg-[#ffffff]">
        ...
        <section className="max-w-5xl mx-auto px-6 py-2 ">
          ...
          <p className="text-base md:text-lg text-gray-700 mb-6">
            Welcome to Downtown! Before you start ordering, let's get on the
            same page about how this whole thing works.
          </p>
          ...
          <p className="text-base md:text-lg text-gray-700 mb-10">
            ...
            We're the ones making sure your campus food game stays strong
          ...
          <div className=" text-gray-700 mb-8">
            ...
            <ul className=" text-base md:text-lg list-disc pl-5 space-y-1">
              <li>
                If your order is cancelled within 2 minutes after payment, you
                get a full refund
              </li>
              <li>
          ...
          <p className="text-base md:text-lg text-gray-700 mb-10">
            Everything on Downtown—the bot, design, name, logo—belongs to
            Heychat International Limited. Don't copy, steal, or try to recreate
            it. That's not cool and it's illegal.
          </p>
          ...
          <p className="text-base md:text-lg text-gray-700 mb-10">
            To the maximum extent permitted by Nigerian law, Heychat
            International Limited isn't liable for any indirect, incidental, or
            consequential damages from using Downtown.
          </p>
          ...
          <p className="text-base md:text-lg text-gray-700 mb-10">
            These Terms may change as we improve our services. We’ll notify
            users via WhatsApp or on our website.
          </p>
