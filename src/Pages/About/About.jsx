...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us - Downtown by HeyChat</title>
        <meta
          name="description"
          content="Learn about Downtown, the premier food delivery service for students in Ota. Powered by HeyChat International Limited."
        />
        <link rel="canonical" href="https://downtown.ng/about-company" />
      </Helmet>
      <div className=" text-gray-800">
        ...
        <section className="max-w-7xl mx-auto px-6 py-2 mb-12 leading-relaxed">
          ...
          <p className="text-[16px] md:text-[18px] text-gray-700 mb-10">
            ...
            understanding of campus life, we're making it easier than ever to
          ...
          <p className="text-[16px] md:text-[18px] text-gray-700 mb-10">
            ...
            (HeyChat), a company founded at Bells University of Technology with
            a simple goal: to solve real problems facing students in private
            universities across Nigeria. We started by asking ourselves, "What
            do students actually need?" The answer was clear, convenient access
            to food and seamless payment solutions that work within the campus
            ecosystem.
          </p>
          ...
          <div className="text-[16px] md:text-[18px] text-gray-700 mb-10">
            <p className="mb-2">
              ...
              the entire food ordering experience for university students.
              Through a simple chat interface on a platform you already use
              daily, you can:
            </p>
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Get your food delivered straight to your location on campus
              </li>
            </ul>
          </div>
          ...
          <p className="text-[16px] md:text-[18px] text-gray-700 mb-10">
            ...
            student feedback and exploring new ways Downtown can make campus
            life better for Nigerian university students.
          </p>
        </section>
